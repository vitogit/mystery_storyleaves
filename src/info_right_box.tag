<info_right_box >
  ...
  <div class="panel panel-info characters_box">
    ...
    <div class="panel-body">
      <ul class="list-group">
        ...
        <li riot-tag="list-group-item" header="Victima" text={this.resources['victim'].card.text.replace('Personaje:','')}></li>
      </ul>
    </div>
  </div>
  ...
  <div class="panel panel-info characters_box">
    <div class="panel-heading"><h4 class="panel-title">Interrogantes del enigma</h4></div>
    <div class="panel-body">
      <ul class="list-group">

        <li class="list-group-item list-group-item-heading">Quien? <br> <input type="text"> </input></li>
        <li class="list-group-item list-group-item-heading">Por que?  <br><input type="text"> </input></li>
        <li class="list-group-item list-group-item-heading">Como? <br>  <input type="text"> </input></li>
      </ul>
    </div>
  </div>
